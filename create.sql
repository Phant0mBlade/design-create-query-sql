...
-- A) Let organisers CREATE new event
...
------------------------------------------------------------------------------
-- B) Let Students register for the events
------------------------------------------------------------------------------
-- The student can only register to an event if the event is not over.
-- This is a generic query for student to register
...
INSERT INTO Registration (student_reg_date, stud_id, event_id, student_rating)
VALUES ("2023-11-09 22:12:34", "STUD000023457", "01", (SELECT 0 FROM Event WHERE event_id = "01" AND event_date > "2023-11-09 22:12:34")),
        ("2023-11-12 21:11:56", "STUD000023457", "02", (SELECT 0 FROM Event WHERE event_id = "02" AND event_date > "2023-11-12 21:11:56")),
        ("2023-11-13 10:24:47", "STUD000023458", "02", (SELECT 0 FROM Event WHERE event_id = "02" AND event_date > "2023-11-13 10:24:47")),
        ("2023-11-24 22:12:34", "STUD000023459", "03", (SELECT 0 FROM Event WHERE event_id = "03" AND event_date > "2023-11-24 22:12:34")),
        ("2023-11-19 22:12:34", "STUD000023458", "03", (SELECT 0 FROM Event WHERE event_id = "03" AND event_date > "2023-11-19 22:12:34")),
        ("2023-11-17 22:12:34", "STUD000023459", "05", (SELECT 0 FROM Event WHERE event_id = "05" AND event_date > "2023-11-17 22:12:34")),
        ("2023-11-21 22:12:34", "STUD000023460", "05", (SELECT 0 FROM Event WHERE event_id = "05" AND event_date > "2023-11-21 22:12:34")),
        ("2023-11-21 22:12:34", "STUD000023462", "06", (SELECT 0 FROM Event WHERE event_id = "06" AND event_date > "2023-11-21 22:12:34")),
        ("2023-11-21 22:12:34", "STUD000023463", "06", (SELECT 0 FROM Event WHERE event_id = "06" AND event_date > "2023-11-21 22:12:34")),
        ("2023-11-21 22:12:34", "STUD000023457", "03", (SELECT 0 FROM Event WHERE event_id = "03" AND event_date > "2023-11-21 22:12:34")),
        ("2023-11-21 22:12:34", "STUD000023457", "04", (SELECT 0 FROM Event WHERE event_id = "04" AND event_date > "2023-11-21 22:12:34")),
        ("2023-11-21 22:12:34", "STUD000023457", "05", (SELECT 0 FROM Event WHERE event_id = "05" AND event_date > "2023-11-21 22:12:34")),
        ("2023-11-21 22:12:34", "STUD000023457", "06", (SELECT 0 FROM Event WHERE event_id = "06" AND event_date > "2023-11-21 22:12:34")),
        ("2023-11-21 22:12:34", "STUD000023457", "07", (SELECT 0 FROM Event WHERE event_id = "07" AND event_date > "2023-11-21 22:12:34")),
        ("2023-11-21 22:12:34", "STUD000023457", "08", (SELECT 0 FROM Event WHERE event_id = "08" AND event_date > "2023-11-21 22:12:34")),
        ("2023-11-21 22:12:34", "STUD000023457", "09", (SELECT 0 FROM Event WHERE event_id = "09" AND event_date > "2023-11-21 22:12:34")),
        ("2023-11-21 22:12:34", "STUD000023457", "10", (SELECT 0 FROM Event WHERE event_id = "10" AND event_date > "2023-11-21 22:12:34")),
        ("2023-11-21 22:12:34", "STUD000023457", "11", (SELECT 0 FROM Event WHERE event_id = "11" AND event_date > "2023-11-21 22:12:34")),
        ("2023-11-21 22:12:34", "STUD000023457", "12", (SELECT 0 FROM Event WHERE event_id = "12" AND event_date > "2023-11-21 22:12:34"));
INSERT INTO Registration (student_reg_date, stud_id, event_id, student_rating)
...
-- B) Let Students rate the EVENTS
...
------------------------------------------------------------------------------
-- View Creation to use in further queries
-- These views are used in part D) and E) of the coursework
------------------------------------------------------------------------------
